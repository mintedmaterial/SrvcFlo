...
import { ImageIcon, Video, Wallet, Clock, CheckCircle, Loader2, Zap, LogIn, User, ExternalLink } from "lucide-react"
...
const CONTRACT_ADDRESS = "0x..." // Deploy the contract and update this
...
export function AIGeneration() {
  ...
  const fetchUserStats = async () => {
    ...
    try {
      ...
      setUserGenerations(12) // Placeholder
    } catch (error) {
  ...
  const handlePayWithS = async () => {
    ...
    try {
      ...
      const sTokenAmount = parseEther("3") // 3 S tokens
      
      // Check allowance first (you'd implement this)
  ...
  const handleFreeGeneration = async () => {
    ...
    try {
      // Call backend for free generation using HuggingFace models
      ...
      if (data.success) {
        ...
        const newGeneration: GenerationItem = {
          ...
          paymentMethod: 'credits' // Free generation
        }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">Create images and videos with AI • Powered by Sonic</p>
          </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">Connected to Sonic</div>
                  </div>
                  <Button
                    size="sm"
                    variant="ghost"
            ...
            <Card className="bg-gray-800/50 border-gray-700">
              <CardContent className="p-4">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="text-sm font-medium">{userCredits} Credits</div>
                    <div className="text-xs text-gray-400">{userGenerations} generations</div>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  {userCredits > 0 && (
                    ...
                    >
                      {isGenerating || isContractPending ? (
                        <>
                          <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                          Processing...
                        </>
          ...
          <div className="lg:col-span-2">
            <Card className="bg-gray-800/50 border-gray-700">
              <CardHeader>
                <CardTitle>Generation Feed</CardTitle>
                <p className="text-sm text-gray-400">Your AI creations powered by HuggingFace and premium models</p>
              </CardHeader>
              <CardContent>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              ...
                              <div className="text-xs text-gray-400">
                                Paid with {gen.paymentMethod === 'credits' ? 'Free/Credits' : gen.paymentMethod}
                              </div>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
